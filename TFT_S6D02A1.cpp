...
/***************************************************************************************
** Function name:           TFT_S6D02A1
** Description:             Constructor , we must use hardware SPI pins
***************************************************************************************/
TFT_S6D02A1::TFT_S6D02A1(int16_t w, int16_t h)
{
  _cs   = TFT_CS;
  _dc   = TFT_DC;
  _rst  = TFT_RST;
...
***************************************************************************************/
void TFT_S6D02A1::spiwrite(uint8_t c)
{
...
void TFT_S6D02A1::commandList (const uint8_t *addr)
{
	...
	while (numCommands--)                           // For each command...
	{
		...
		ms = numArgs & S6D02A1_INIT_DELAY;      // If hibit set, delay follows args
		numArgs &= ~S6D02A1_INIT_DELAY;         // Mask out delay bit
...
***************************************************************************************/
void TFT_S6D02A1::drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color)
{
  int16_t f = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = - r - r;
...
***************************************************************************************/
void TFT_S6D02A1::drawCircleHelper( int16_t x0, int16_t y0, int16_t r, uint8_t cornername, uint16_t color)
{
  int16_t f     = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = -2 * r;
...
***************************************************************************************/
void TFT_S6D02A1::fillCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color)
{
...
void TFT_S6D02A1::fillCircleHelper(int16_t x0, int16_t y0, int16_t r, uint8_t cornername, int16_t delta, uint16_t color)
{
  int16_t f     = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = -r - r;
...
***************************************************************************************/
void TFT_S6D02A1::drawEllipse(int16_t x0, int16_t y0, int16_t rx, int16_t ry, uint16_t color)
{
  if (rx<2) return;
  if (ry<2) return;
  int16_t x, y;
...
***************************************************************************************/
void TFT_S6D02A1::fillEllipse(int16_t x0, int16_t y0, int16_t rx, int16_t ry, uint16_t color)
{
  if (rx<2) return;
  if (ry<2) return;
  int16_t x, y;
...
***************************************************************************************/
// Draw a rectangle
void TFT_S6D02A1::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
void TFT_S6D02A1::drawRoundRect(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color)
{
  // smarter version
...
void TFT_S6D02A1::fillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color)
{
  // smarter version
...
***************************************************************************************/
// Draw a triangle
void TFT_S6D02A1::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color)
{
...
void TFT_S6D02A1::fillTriangle ( int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color)
{
  int16_t a, b, y, last;
...
***************************************************************************************/
void TFT_S6D02A1::drawBitmap(int16_t x, int16_t y, const uint8_t *bitmap, int16_t w, int16_t h, uint16_t color)
{
...
***************************************************************************************/
void TFT_S6D02A1::setCursor(int16_t x, int16_t y)
{
  cursor_x = x;
  cursor_y = y;
}
...
***************************************************************************************/
void TFT_S6D02A1::setCursor(int16_t x, int16_t y, uint8_t font)
{
  textfont = font;
  cursor_x = x;
  cursor_y = y;
...
***************************************************************************************/
void TFT_S6D02A1::setTextSize(uint8_t s)
{
...
***************************************************************************************/
void TFT_S6D02A1::setTextFont(uint8_t f)
{
...
***************************************************************************************/
void TFT_S6D02A1::setTextColor(uint16_t c)
{
...
***************************************************************************************/
void TFT_S6D02A1::setTextColor(uint16_t c, uint16_t b)
{
  textcolor   = c;
  textbgcolor = b;
}
...
***************************************************************************************/
void TFT_S6D02A1::setTextWrap(boolean w)
{
  textwrap = w;
}
...
***************************************************************************************/
void TFT_S6D02A1::setTextDatum(uint8_t d)
{
  textdatum = d;
}
...
***************************************************************************************/
void TFT_S6D02A1::setTextPadding(uint16_t x_width)
{
  padX = x_width;
}
...
***************************************************************************************/
uint8_t TFT_S6D02A1::getRotation(void)
{
  return rotation;
}
...
int16_t TFT_S6D02A1::width(void)
{
  return _width;
}
...
***************************************************************************************/
int16_t TFT_S6D02A1::height(void)
{
  return _height;
}
...
***************************************************************************************/
int16_t TFT_S6D02A1::textWidth(char *string, int font)
{
...
uint16_t TFT_S6D02A1::fontsLoaded(void)
{
  return fontsloaded;
}
...
***************************************************************************************/
int16_t TFT_S6D02A1::fontHeight(int font)
{
...
***************************************************************************************/
void TFT_S6D02A1::drawChar(int16_t x, int16_t y, unsigned char c, uint16_t color, uint16_t bg, uint8_t size)
{
#ifdef LOAD_GLCD
...
void TFT_S6D02A1::drawPixel(uint16_t x, uint16_t y, uint16_t color)
{
...
***************************************************************************************/
void TFT_S6D02A1::pushColor(uint16_t color, uint16_t len)
{
  spi_begin();
...
void TFT_S6D02A1::pushColors(uint16_t *data, uint8_t len)
{
  uint16_t color;
  spi_begin();
...
void TFT_S6D02A1::pushColors(uint8_t *data, uint16_t len)
{
  spi_begin();
  len = len<<1;
...
***************************************************************************************/
uint16_t TFT_S6D02A1::color565(uint8_t r, uint8_t g, uint8_t b)
{
...
void TFT_S6D02A1::setRotation(uint8_t m)
{
  ...
  switch (rotation) {
    case 0:
      writedata(S6D02A1_MADCTL_MX | S6D02A1_MADCTL_MY | S6D02A1_MADCTL_BGR);
      _width  = S6D02A1_TFTWIDTH;
      _height = S6D02A1_TFTHEIGHT;
      break;
    case 1:
      writedata(S6D02A1_MADCTL_MV | S6D02A1_MADCTL_MY | S6D02A1_MADCTL_BGR);
      _width  = S6D02A1_TFTHEIGHT;
      _height = S6D02A1_TFTWIDTH;
      break;
    case 2:
      writedata(S6D02A1_MADCTL_BGR);
      _width  = S6D02A1_TFTWIDTH;
      _height = S6D02A1_TFTHEIGHT;
      break;
    case 3:
      writedata(S6D02A1_MADCTL_MX | S6D02A1_MADCTL_MV | S6D02A1_MADCTL_BGR);
      _width  = S6D02A1_TFTHEIGHT;
      _height = S6D02A1_TFTWIDTH;
      break;
  }
...
***************************************************************************************/
size_t TFT_S6D02A1::write(uint8_t uniCode)
{
...
***************************************************************************************/
int TFT_S6D02A1::drawChar(unsigned int uniCode, int x, int y, int font)
{
...
***************************************************************************************/
int TFT_S6D02A1::drawString(char *string, int poX, int poY, int font)
{
  int16_t sumX = 0;
  uint8_t padding = 1;
...
***************************************************************************************/
int TFT_S6D02A1::drawCentreString(char *string, int dX, int poY, int font)
{
...
***************************************************************************************/
int TFT_S6D02A1::drawRightString(char *string, int dX, int poY, int font)
{
  byte tempdatum = textdatum;
  int sumX = 0;
  textdatum = TR_DATUM;
...
***************************************************************************************/
int TFT_S6D02A1::drawNumber(long long_num, int poX, int poY, int font)
{
  char str[12];
...
int TFT_S6D02A1::drawFloat(float floatNumber, int dp, int poX, int poY, int font)
{
  ...
  // For error put ... in string and return (all TFT_S6D02A1 library fonts contain . character)
